...
class MobileNetv2_Embedder(object):
    ...
    def __init__(
        ...
        self.model = MobileNetV2_bottle(input_size=INPUT_WIDTH, width_mult=1.0).to('cuda')
    ...
    def preprocess(self, np_image):
        ...
        dtype=torch.float32, non_blocking=True) / 255.0
        # Normalize the image directly on the GPU
