...
def get_center_window_distance(depth_frame, x1, y1, x2, y2, window_size=10):
    ...
    for x in range(window_x1, window_x2):
        for y in range(window_y1, window_y2):
            ...
            if distance > 0:  # Ignore invalid distancesr
            ...
            for box in result.boxes:
                ...
                if cls == 0:  # Assuming class 0 is 'person'
                    ...
                    if box_width > 10 and box_height > 10:
                        ...
                        depth = get_center_window_distance(depth_frame, x1, y1, x2, y2, window_size=10)
                        ...
                        cmd_vel = Twist()
                        cmd_vel.linear.x = max(min(velocity, 0.4), -0.4)  # Limit speed
                        ...
                        # If the box is too small, don't move
